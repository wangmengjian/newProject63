                    ...
                    <div class="card card-default card-outline">
                        ...
                        <div class="card-body p-0">
                            <div class="mailbox-controls">
                                ...
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default btn-sm" id="deleteBtn"><i
                                            class="far fa-trash-alt"></i></button>
                                    <!-- /.btn-group -->
                                    <button type="button" class="btn btn-default btn-sm refresh"><i
                                            class="fas fa-sync-alt"></i></button>
                                    <button type="button" class="btn btn-default btn-sm addDocBtn"><i
...
<script>
    $(function () {
        ...
        $(".addDocBtn").click(function () {
            window.location.href = "<c:url value='/render/toAddDocuments'/>";
        })
        ...
        function Bootstrap_paging(page,pageSize) {
            ...
            $.ajax({
                type: "GET",
                url: "<c:url value='/api/document/queryDocuments'/>",
                dataType: "json",
                data: json,
                beforeSend:function () {
                    $("#tableContent").html("\n" +
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.result.size; i++) {
                        ...
                        var node = "<tr documentId=" + data.result.data[i].id + ">" +
                            ...
                            "                    <td class='docName'><a target=\"_blank\" href='<c:url value="/render/toEditDocuments/"/>" + data.result.data[i].id + "'>" + data.result.data[i].docName + "</a></td>" +
